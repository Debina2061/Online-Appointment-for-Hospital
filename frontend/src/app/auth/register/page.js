  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/v1/api/auth/create-user",
        {
          method: "POST",
          headers: {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-2xl text-center border border-green-200">
          <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircleIcon className="w-10 h-10 text-green-600" />
          </div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Welcome to D-code Hospital!
          </h2>
          <p className="text-gray-600 mb-6 leading-relaxed">
            Your account has been created successfully. You can now access our
            healthcare services and book appointments with our specialists.
          </p>
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-blue-100 text-lg leading-relaxed">
                ...
                connect with top specialists, and manage your health digitally.
              </p>

              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <ShieldCheckIcon className="w-6 h-6 text-blue-200 flex-shrink-0 mt-1" />
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <ClockIcon className="w-6 h-6 text-blue-200 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-white font-semibold">24/7 Access</h3>
                    <p className="text-blue-200 text-sm">
                      Book appointments and access services anytime, anywhere
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <HeartIcon className="w-6 h-6 text-blue-200 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-white font-semibold">Expert Care</h3>
                    <p className="text-blue-200 text-sm">
                      Connect with certified specialists and healthcare
                      professionals
                    </p>
                  </div>
                </div>
          ...
          <div className="relative z-10">
            <div className="bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
              <p className="text-blue-100 text-sm italic">
                &ldquo;Trusted by over 50,000+ patients for quality healthcare
                services since 2008&rdquo;
              </p>
            </div>
          </div>
        </div>
